...
class X {
  ...
  #initRenderer() {
    ...
    // Guard: if canvas still null/undefined, bail out
    if (!this.canvas) {
      console.error("Three: Canvas element is null");
      return;
    }
...
const Ballpit: React.FC<BallpitProps> = ({
  ...
  useEffect(() => {
    ...
    // setTimeout pushes initialization to after the canvas is fully in the DOM
